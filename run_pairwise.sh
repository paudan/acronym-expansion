...
python3 models/pairwise.py train-model --training-data dataset_train_bert_pairwise.h5 --validation-data dataset_dev_bert_pairwise.h5 \
  --output-dir=bert-pairwise-simple --classifier-model simple
python3 models/pairwise.py predict-sentences --test-data data/test.json --model-dir bert-pairwise --transformer-model bert-base-uncased \
  --embed-full --classifier-model simple
